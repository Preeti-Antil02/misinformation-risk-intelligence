...
- Pure CSS checkbox-driven toggle with full-viewport transparent backdrop label.
- Clicking the 'Bot' pill opens/closes the popover.
- Clicking ANYWHERE else on the screen hits the full-viewport backdrop label and immediately closes the popover.
...
def render_telegram_popover():
    ...
    <div class="bot-pill-wrap">
        ...
        <input type="checkbox" id="tg_bot_toggle" class="tg-toggle-input" />

        <!-- Trigger Pill Button (Label for Checkbox) -->
        <label for="tg_bot_toggle" class="bot-pill" id="botPillBtn" title="RiskLens Telegram Intelligence Bot">
        ...
        <!-- Full-viewport transparent backdrop label (clicking anywhere unchecks the box) -->
        <label for="tg_bot_toggle" class="bot-backdrop" aria-label="Close Telegram popover"></label>
