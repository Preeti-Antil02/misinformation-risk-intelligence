...
var ND = {
  ...
  qwen:{emo:"💬",step:"STEP 4E OF 8",title:"Offline SLM Benchmark — Qwen2.5-3B",badge:"OFFLINE BENCHMARK",
    what:"Small Language Model (Qwen2.5, 3B parameters) evaluated for cross-domain zero-shot reasoning in offline batch benchmarks. In real-time production serving, the sub-second fast neural ensemble (LogReg, XGBoost, RoBERTa, MuRIL) runs in <250ms.",
    ana:"An external academic benchmark used to measure zero-shot generalization across domain shifts without slowing down live user interactions.",
    inp:"Test claims in offline evaluation batches",
    out:"Offline zero-shot benchmark metrics & reasoning traces"},
  muril:{emo:"🇮🇳",step:"STEP 4F OF 8",title:"Indian Language Specialist AI",badge:"INDIC EXPERT",
    what:"If your message is in Hindi, Tamil, Telugu, Bengali, Marathi, or Gujarati, it goes to a <strong>specialist AI trained only on Indian languages</strong> (MuRIL). It bypasses English-only detectors and provides native multilingual representation.",
  ...
  stack:{emo:"🗳",step:"STEP 5B OF 8",title:"Platt Calibrated Stacking Meta-Learner",badge:"META-LEARNER ENSEMBLE",
    what:"All base classifiers output probability estimates. A <strong>Platt/Isotonic calibrated meta-learner</strong> combines those scores with learned optimal weights (AUC: 0.9744, ECE: 0.009) to guarantee reliable confidence calibration.",
    ana:"A senior analyst who reviews reports from multiple specialist detectives and synthesizes a calibrated, mathematically sound final risk assessment.",
    inp:"Probability scores from base classifiers",
    out:"Calibrated combined probability score"},
  ...
  ag1:{emo:"🔎",step:"STEP 6A OF 8",title:"Heuristic & Linguistic Claim Extractor",badge:"CLAIM EXTRACTOR",
    what:"Analyzes the input text using <strong>linguistic pattern matching and entity recognition</strong> to identify discrete, checkable factual assertions while filtering out non-factual rhetorical sentiment.",
    ...
    out:"The primary verifiable factual claim"},
  ag2:{emo:"🌍",step:"STEP 6B OF 8",title:"Multi-Query Live Web Researcher",badge:"WEB RESEARCHER",
    what:"RiskLens generates multiple targeted search queries across <strong>Google Fact Check Tools API and live web search engines (Serper Google Search / DuckDuckGo)</strong> with real-time article text extraction.",
    ...
    out:"List of real-world sources and evidence snippets"},
  ag3:{emo:"⚖️",step:"STEP 6C OF 8",title:"Evidence-Weighted Verdict Synthesizer",badge:"VERDICT SYNTHESIZER",
    what:"Synthesizes the final verdict by blending <strong>70% Web Evidence Grounding + 30% Calibrated Neural Risk Baseline</strong>. Generates transparent explanations with cited sources or flags inconclusive claims.",
