...
This file demonstrates the API design for the system.
The primary user interface is the Streamlit app (streamlit_app.py).
This API can be run independently for programmatic access.
